...
//   const { sessionId } = useLocalSearchParams() as { sessionId: string | null };
...
//     const chatRef = doc(db, 'chats', sessionId); // Correction du type pour doc
...
//         try {
//           const msgRef = doc(db, 'chats', sessionId, 'messages', msg.id); // Correction du type pour doc
